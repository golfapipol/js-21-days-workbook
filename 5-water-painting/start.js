(()=> {
    ...
    const onMouseMove = (context, previousPoint) => ({pageX, pageY}) => {
    ...
    const onMouseEnter = (previousPoint) => ({pageX, pageY}) => {
    ...
    const run = () => {
        ...
        canvas.addEventListener('mouseenter', onMouseEnter(previousPoint))
        canvas.addEventListener('mousemove', onMouseMove(context, previousPoint))
    }
    run()
})()